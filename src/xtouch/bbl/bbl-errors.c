...
const char *hms_error_values[] PROGMEM = {
  ...
  "Failed to feed the filament outside the AMS. Please clip the end of the filament flat and check to see if the spool is stuck. Please refer to the Assistant for details.",
  "Failed to pull back the filament from the toolhead to AMS. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "Failed to extrude the filament. Possible cause: extruder or nozzle clogged. Please refer to the Assistant for details.",
  "Timeout purging old filament. Possible cause: filament stuck or extruder/nozzle clogged. Please refer to the Assistant for details.",
  "Failed to extrude the filament. Possible cause: extruder or nozzle clogged. Please refer to the Assistant for details.",
  "Timeout purging old filament. Possible cause: filament stuck or extruder/nozzle clogged. Please refer to the Assistant for details.",
  "Failed to pull back the filament from the toolhead to AMS. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "Failed to feed the filament outside the AMS. Please clip the end of the filament flat and check to see if the spool is stuck. Please refer to the Assistant for details.",
  "Failed to feed the filament into the toolhead. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "PTFE tube detached during the feeding process. Please check if the PTFE tube is connected to the AMS and extruder.",
  "PTFE tube detached during the feeding process. Please check if the PTFE tube is connected to the AMS and extruder.",
  "Failed to feed filament into the toolhead. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "Failed to pull back the filament from the toolhead to AMS. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "Failed to feed the filament into the toolhead. Possible cause: filament or spool stuck. Please refer to the Assistant for details.",
  "Timeout purging old filament. Possible cause: filament stuck or extruder/nozzle clogged. Please refer to the Assistant for details.",
  "Failed to feed the filament outside the AMS. Please clip the end of the filament flat and check to see if the spool is stuck. Please refer to the Assistant for details.",
  ...
  "The hotend cooling fan speed is too slow or stopped. It may be stuck or the connector is not plugged in properly.",
  "The hotend cooling fan speed is too slow or stopped. It may be stuck or the connector may not be plugged in properly.",
  "The build plate may not be properly placed. If this message appears repeatedly, please check the Wiki for more reasons.",
  "The build plate may not be properly placed. If this message appears repeatedly, please check the Wiki for more reasons.",
  "The build plate may not be properly placed. If this message appears repeatedly, please check the Wiki for more reasons.",
  "The build plate may not be properly placed. If this message appears repeatedly, please check the Wiki for more reasons.",
  "The build plate may not be properly placed. If this message appears repeatedly, please check the Wiki for more reasons.",
  ...
  "The position sensor of extrusion motor is abnormal. The connection to sensor may be loose.",
  ...
  "Failed to pull out the filament from the extruder. Possible causes: clogged extruder or broken filament. Refer to the Assistant for details.",
  "Failed to get AMS mapping table; please click \"Resume\" to retry",
  "Failed to pull out the filament from the extruder. Possible causes: clogged extruder or broken filament. Refer to the Assistant for details.",
  "AMS filament ran out. Please put a new filament into AMS and click the \"Retry\" button.",
  "Failed to pull out the filament from the extruder. Possible causes: clogged extruder or broken filament. Refer to the Assistant for details.",
...
const char *device_error_values[] PROGMEM = {
  ...
  "Nozzle temperature problem detected. Refer to the Assistant to re-connect the hotend connector. POWER OFF the printer before this operation to avoid a short circuit.",
  "The hotend cooling fan speed is abnormal.",
  "The hotend cooling fan speed is abnormal.",
  "Current filament will be used in this print job. Settings cannot be changed.",
  "Printing paused. It was due to the pause command added in the printing file.",
  ...
  "The AMS failed to send out filament. You can clip the end of your filament flat, and reinsert. If this message persists, please check the PTFE tubes in AMS for any signs of wear and tear.",
  "The AMS failed to send out filament. You can clip the end of your filament flat, and reinsert. If this message persists, please check the PTFE tubes in AMS for any signs of wear and tear.",
  "AMS filament ran out. Please put a new filament into the same AMS slot.",
  ...
  "Foreign objects detected on heatbed, Please check and clean the heatbed, Then tap \"Resume\" button to resume the print job.",
